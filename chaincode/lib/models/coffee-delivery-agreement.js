...
class CoffeeDeliveryAgreement {
  constructor() {
   ...
   /*  this.deliveryLongtitude = "";
    this.deliveryLatitude = "";
    this.deliveryCity = "";
    this.deliveryCountry = ""; */
    this.pricePercentage =
      ""; /** additional payment from the average price of similar coffee price at day */
    this.startDate = "";
    this.endDate = "";
  ...
  static from(bufferOrJson) {
    ...
    const result = new CoffeeDeliveryAgreement();
   ...
   /*  result.deliveryLongtitude = bufferOrJson.deliveryLongtitude;
    result.deliveryLatitude = bufferOrJson.deliveryLatitude;
    result.deliveryCity = bufferOrJson.deliveryCity;
    result.deliveryCountry = bufferOrJson.deliveryCountry; */
...
module.exports = CoffeeDeliveryAgreement;
