...
fetchChannelConfig() {
  ...
  set -x
  peer channel fetch config config_block.pb -o orderer.adey-meselesh.de:4000 --ordererTLSHostnameOverride orderer.adey-meselesh.de -c $CHANNEL --tls --cafile "$ORDERER_CA"
  { set +x; } 2>/dev/null
